# BestFarmFriend — Application Specification
...
BestFarmFriend is a weather-driven farm advisory web application built with Blazor (.NET 10).
...
BestFarmFriend/
  BestFarmFriend.sln
  src/
    BestFarmFriend.Web/           -- Blazor Web App (host + WASM client)
      Components/
        Layout/
        Shared/
          WeatherSvg/
      ...
      wwwroot/
        css/
        svg/
    BestFarmFriend.Core/          -- Domain models, interfaces, rule engine
      Models/
      Interfaces/
      Rules/
      Services/                -- domain logic only
    BestFarmFriend.Infrastructure/ -- EF Core, weather API client, AI client
      Data/
        Migrations/
        Seed/
      WeatherApi/
  ...
  tests/
    ...
    BestFarmFriend.Tests.Integration/
```
